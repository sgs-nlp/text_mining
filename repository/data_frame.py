...
# from repository.pre_processing import normalizer
#
#
# class Corpus:
...
#         self._document = normalizer(string)
#         return self._document
#
#     def to_dict(self):
#         if not self.is_valid:
...
#         self._sentence = normalizer(self._string)
#         return self._sentence
#
#     def to_dict(self):
#         if not self.is_valid:
...
#             return self._word
#         self._word = normalizer(self._string)
#         return self._word
#
#     def to_dict(self):
#         if not self.is_valid:
